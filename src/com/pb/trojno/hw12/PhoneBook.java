...
import com.pb.trojno.hw12.DateDeserializer;
import com.pb.trojno.hw12.DateSerializer;
...
class PhoneBook implements Comparable<PhoneBook>, Serializable {
   ...
   public PhoneBook(String fio, LocalDate birthDate, List<String> phonesnum,
